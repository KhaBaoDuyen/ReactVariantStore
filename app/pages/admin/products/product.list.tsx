			...
			<div className="">
				<span className="flex justify-between">
					...
					<Link
						...
						className="p-2 bg-accent-600 text-white rounded-md shadow-md"
					>
						Thêm sản phẩm
					</Link>
				</span>
				...
				<div className="mt-10 ">
					<div className="">
						<div
							className="flex gap-2 w-12/12 overflow-x-auto overflow-y-hidden 
						...
						<div className="">
							<table className="w-full border-separate border-spacing-y-3">
								<thead className="sticky top-0 z-10 text-gray-700 shadow">
									<tr>
										<th className="py-3 px-4 text-left bg-gray-100 rounded-l-md">
											Id
										</th>
										<th colSpan={2} className="py-3 px-4 bg-gray-100 text-left">
											Tên sản phẩm
										</th>
										...
										<th className="py-3 px-4 text-left bg-gray-100  rounded-r-md">
											<EllipsisVertical />
										</th>
									</tr>
								</thead>
									...
									<tbody>
										{filterProductBYCategory.length === 0 ? (
											<tr>
												<td
													colSpan={9}
													className="text-center py-8 text-gray-400 bg-white rounded-md"
												>
													Không có sản phẩm
												</td>
											</tr>
											...
											filterProductBYCategory.map((p, index) => (
												<tr key={index} className="shadow hover:scale-102">
													<td className="py-3 px-4 bg-white rounded-l-md">
														{index + 1}
													</td>
