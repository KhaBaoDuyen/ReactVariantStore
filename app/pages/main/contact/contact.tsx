...
import { ArrowRight, Mail, MousePointer2, Phone } from "lucide-react";
			...
			<div className="lg:w-10/12 w-11/12  bg-white rounded-xl shadow-xl overflow-hidden grid grid-cols-1 lg:grid-cols-2">
				<div className="p-8 lg:p-10 flex flex-col justify-center">
					...
					<h1 className="text-4xl lg:text-5xl font-extrabold text-slate-900 leading-tight mb-6">
						Nâng Cấp <span className="text-accent-600">Trải Nghiệm</span> Gear
						Của Bạn
					</h1>
					<p className="text-gray-500 text-lg mb-10 max-w-md">
						Bạn đang tìm kiếm những mẫu bàn phím cơ, chuột gaming hay phụ kiện
						máy tính cao cấp nhất? Đừng ngần ngại liên hệ với Yejara Team.
					</p>
