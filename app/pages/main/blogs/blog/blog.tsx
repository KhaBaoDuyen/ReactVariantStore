		...
		<div>
			...
			>
				<div className="lg:w-10/12 w-full mx-auto ">
					<div
						className="min-h-full py-10 bg-blogPage bg-no-repeat flex items-center justify-center 
      lg:rounded-4xl  shadow-lg flex-col gap-2"
					>
						<h1 className="text-accent-600 font-bold  lg:text-[2rem] text-[1.3rem]">
							Tin tức
						</h1>
			...
			<div className=" mx-auto w-11/12 py-6 lg:w-10/12">
				<SwipeCategoriesSlide data={CATEGOGY_DATA} type="image" variant="six" />
			</div>

			<section className="lg:w-10/12 mx-auto w-11/12 lg:mt-10">
				<h1 className="text-[2rem] font-bold text-accent-600 text-center">
					Tin tức mới
				</h1>
