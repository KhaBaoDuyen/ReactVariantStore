	...
	return (
		<div className="bg-primary-100">
				...
				<span className="lg:w-10/12 flex  mx-auto ">
					...
					>
						<h1 className="text-accent-600 font-bold lg:text-3xl text-2xl">
							<TextType
								text={[
									"Giúp Bạn Dễ Dàng Tiếp Cận Thiết Bị Công Nghệ Chính Hãng.",
								]}
								typingSpeed={75}
						...
						<p className="text-muted text-sm text-justify">
							Từ học tập, làm việc đến chơi game và giải trí, chúng tôi cung cấp
							các thiết bị điện tử chất lượng cao như bàn phím, chuột, màn hình
							và phụ kiện công nghệ, mang đến trải nghiệm ổn định, mượt mà và
						...
						<div className="flex flex-col gap-2">
							<div className="flex gap-3">
								<img
									src="/assets/images/Icon/Checkmark.png"
									alt=""
									className="lg:block:w-10 w-7 h-7"
								/>
							...
							<div className="flex gap-3">
								...
								/>
								<p className="text-white lg:text-md text-sm ">
									Bảo hành đầy đủ, đổi trả nhanh chóng
								</p>
							</div>
							...
							<div className="flex gap-3">
								...
								/>
								<p className="text-white lg:text-md text-sm ">
									Phù hợp học tập, làm việc và gaming
								</p>
							</div>
							...
							<div className="flex gap-3">
								...
								/>
								<p className="text-white lg:text-md text-sm ">
									Nhiều phân khúc giá, dễ dàng lựa chọn
								</p>
							</div>
						</div>
						...
						<span className="flex flex-col mt-3 lg:flex-row lg:gap-4 gap-3">
							<Button
								...
								iconPosition="right"
								onClick={() =>
									console.log("Chuyen huong trang den trang sap pham")
								}
								color={"accent-600"}
							>
								Xem thêm
			...
			<section className="w-10/12 mx-auto ">
				<SwipeCategoriesSlide data={CATEGOGY_DATA} />
			</section>
				...
				<div className=" mx-auto bg-bannerSection">
					<div className="lg:w-10/12 w-11/12 mx-auto py-4 lg:py-10 flex flex-col gap-4 ">
						...
						<span className="flex lg:flex-row flex-col gap-3">
							<Link
								className="px-3 py-1 w-fit hover:border-1 hover:bg-transparent hover:text-white rounded-md
                bg-white/40"
								to="/products"
							>
			...
			<section className="py-5 flex mt-3 flex-col justify-center items-center gap-2">
				<span className="text-center">
					<h1 className="lg:text-3xl text-md title-primary-600 text-center">
						{" "}
						Cập nhật nổi bật
					</h1>
					<p className="text-muted ">
						Những bài viết vừa được đăng tải từ đội ngũ của chúng tôi.
					</p>
				</span>
			...
			<div className="hidden lg:grid grid-cols-4 py-5 lg:w-10/12 mx-auto gap-5">
				<div className="col-span-2 overflow-hidden group rounded-xl h-[15rem]">
					<img
						src="./assets/images/tlc_keyboards_banner_k60protkl_2a7cf6e5a327492287d04a71350fe4de.jpg"
						alt=""
				...
				<div className="overflow-hidden group rounded-xl h-[15rem]">
					<img
						src="./assets/images/20-1730801598133.jpg"
						alt=""
						className=" group-hover:scale-125 h-full w-full object-cover "
					/>
				</div>
				<div className="overflow-hidden group rounded-xl h-[15rem]">
					<img
						src="./assets/images/ips_banner_1920x680_801fccb12fa947bfb0eda431877d620e.jpg"
						alt=""
						className=" group-hover:scale-125 h-full w-full object-cover "
					/>
				</div>
			...
			<section className=" lg:mt-5 bg-primary-500 py-10">
				<span className="lg:w-10/12 w-11/12 mx-auto grid lg:grid-cols-2">
					...
					>
						...
						<h1 className="text-accent-500 lg:text-4xl font-bold">
							Không chỉ bán sản phẩm – Chúng tôi mang đến trải nghiệm.
						</h1>
						<p className="text-on-primary">
							Chúng tôi chuyên cung cấp bàn phím, chuột và phụ kiện công nghệ
							chính hãng, được chọn lọc kỹ lưỡng về chất lượng, độ bền và hiệu
							năng. Mỗi sản phẩm đều phù hợp cho làm việc, học tập và gaming,
					...
					<div className="lg:block hidden">
						<ImagesStack sensitivity={190} autoplay pauseOnHover />
					</div>
				</span>
			</section>
