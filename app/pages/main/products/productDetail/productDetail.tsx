	...
	return (
		<div className="lg:w-10/12 w-11/12 mx-auto py-5">
			<span className="flex hidden lg:block justify-start font-bold items-center gap-2 mb-2">
				<Link to={"/"} className="text-accent-500 text-accent-600-hover">
					Trang chủ /
				</Link>
				<Link
					to={"/san-pham"}
					className="text-accent-500 text-accent-600-hover"
				>
					Sản phẩm /
				</Link>
				<Link
					to={`/san-pham/${slug}`}
					className="text-muted text-accent-600-hover"
				>
					{slug}
				</Link>
			</span>
				...
				<section className="col-span-9 flex flex-col gap-5 ">
					<div className="lg:grid grid-cols-7 gap-5">
						...
						<div className="group-text col-span-4 ">
								...
								<span className="grid grid-cols-4">
									...
									<div className=" col-span-3 flex flex-wrap gap-2 pr-1  ">
										<span className="bg-white p-1 px-2 rounded-md flex justify-center items-center">
											<button
												className="w-8 h-8 flex justify-center items-center text-primary-700 
                                        rounded-md bg-gray-300"
												onClick={() =>
													setQuantity((prev) => Math.min(maxQuantiry, prev - 1))
												}
											>
												<Minus />
											</button>
							...
							<div className="my-5 bg-white shadow p-5 rounded-md ">
								<p className="text-muted lg:text-md text-sm text-justify">
									Nếu quý khách có bất kỳ thắc mắc nào về sản phẩm, vui lòng
									liên hệ qua email để được hỗ trợ và tư vấn chi tiết trong thời
									gian sớm nhất.
								</p>
					...
					<div className="shadow-xl bg-white p-4 rounded-lg">
						...
						<ul className="list-disc list-inside space-y-2 text-gray-700">
							<li>
								{" "}
								Sản phẩm có thể có sai lệch nhỏ về màu sắc do ánh sáng và màn
								hình hiển thị.{" "}
							</li>
							<li>
								{" "}
								Vui lòng kiểm tra kỹ thông tin sản phẩm trước khi đặt hàng để
								tránh nhầm lẫn.
							</li>
							<li>
								{" "}
								Không tự ý tháo rời hoặc sửa chữa sản phẩm để đảm bảo quyền lợi
								bảo hành.
							</li>
							<li>
								{" "}
								Giữ lại hóa đơn và bao bì sản phẩm để được hỗ trợ đổi trả khi
								cần thiết.
							</li>
						</ul>
					</div>
				...
				<aside className="col-span-3 hidden lg:block">
					<ul className="bg-white rounded-xl w-full shadow-xl p-2">
						<li className="flex gap-2 justify-start py-2 items-center">
							<img
								src="/assets/images/Icon/baphanh.png"
								alt=""
								className="w-8 h-8"
							/>
						...
						<li className="flex gap-2 justify-start py-2 items-center">
							<img
								src="/assets/images/Icon/chinhhang.png"
								alt=""
								className="w-8 h-8"
							/>
						...
						<li className="flex gap-2 justify-start py-2 items-center">
							<img
								src="/assets/images/Icon/nangcap.png"
								alt=""
								className="w-8 h-8"
							/>
						...
						<li className="flex gap-2 justify-start py-2 items-center">
							<img
								src="/assets/images/Icon/hotro.png"
								alt=""
								className="w-8 h-8"
							/>
						...
						<li className="flex gap-2 justify-start py-2 items-center">
							<img
								src="/assets/images/Icon/thanhtoan.png"
								alt=""
								className="w-8 h-8"
							/>
