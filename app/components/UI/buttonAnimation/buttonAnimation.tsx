import type { ButtonAnimationProps } from "./buttonAnimation.type";
...
export const ButtonAnimation = ({
	...
	return (
		<button
			className="bg-button-gradient border-1 border-white/20 min-w-max  p-1 rounded-md text-white
           ml-2 hover:bg-accent-700 flex group overflow-hidden"
		>
			<img
				src={`/assets/images/brands/${imageAlt}`}
				alt={name}
