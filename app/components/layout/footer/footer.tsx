				...
				<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10">
					<div className="lg:col-span-2 flex flex-col gap-3">
						...
						<p className="text-justify text-muted text-sm leading-relaxed">
							Chúng tôi chính thức mở cửa bán key phần mềm giá rẻ tại Việt Nam
							nhằm tạo điều kiện cho mọi người dân trong nước được trải nghiệm
					...
					<div className="lg:col-span-3 flex flex-col gap-6">
						...
						<div className="flex flex-col sm:flex-row gap-4">
							<Button variant="outline">Xem thông tin về Yejara</Button>
							<Button variant="outline">Tìm sản phẩm</Button>
						</div>
					</div>
				</div>
			</div>
