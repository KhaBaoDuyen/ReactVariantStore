			...
			<div className="bg-accent-600 hidden lg:block">
				<ul className="flex items-center justify-between gap-6 px-6 py-3">
					<li className="flex items-center text-sm text-white">
						...
						<span className="leading-none">Tư vấn chuẩn, chọn đúng gear</span>
					</li>
					...
					<li className="flex items-center text-sm text-white">
						...
						<span className="leading-none">Bảo hành gọn, xử lý nhanh</span>
					</li>
					...
					<li className="flex items-center text-sm text-white">
						...
						<span className="leading-none">Giao nhanh 0–3 ngày</span>
					</li>
					...
					<li className="flex items-center text-sm text-white">
						...
						<span className="leading-none">Miễn phí ship từ 1 triệu</span>
					</li>
					...
					<li className="flex items-center text-sm text-white">
						...
						<span className="leading-none">Trả góp 0%</span>
					</li>
				</ul>
			</div>
			...
			<header className=" bg-primary-500 text-white">
				<div className="mx-auto flex w-11/12 lg:w-10/12 items-center justify-between py-3">
					...
					<div className="flex items-center gap-4">
						...
						<Link
							to={"/gio-hang-cua-toi"}
							className="relative hidden sm:flex items-center gap-1 hover:text-red-600"
						>
						...
						<Link
							to={"/dang-nhap"}
							className="hidden lg:flex items-center gap-1 hover:text-red-600"
						>
							<User size={20} />
							<span>Đăng nhập</span>
						</Link>
